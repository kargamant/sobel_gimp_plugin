...
void sobel(GimpDrawable* dr, int gr1[3][3], int gr2[3][3], float multiplier, float (*br)(int, int, int), float (*gr)(int, int))
{
	...
	convolution(&rgin, buff_out1, channels, gr1, multiplier, br);
	convolution(&rgin, buff_out2, channels, gr2, multiplier, br);
	gradient_add(buff_out1, buff_out2, &rgout, channels, br, gr);
